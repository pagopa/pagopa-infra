...
resource "azurerm_logic_app_standard" "logic_app_biz_evt" {
  ...
  storage_account_name       = azurerm_storage_account.logic_app_biz_evt_sa.name
  storage_account_access_key = azurerm_storage_account.logic_app_biz_evt_sa.primary_access_key
