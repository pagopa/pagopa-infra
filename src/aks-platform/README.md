...
| <a name="module_kubernetes_event_exporter"></a> [kubernetes\_event\_exporter](#module\_kubernetes\_event\_exporter) | git::https://github.com/pagopa/terraform-azurerm-v3.git//kubernetes_event_exporter | PAYMCLOUD-95-Add-Kubernetes-events-exporter-helm-on-terraform-modules-v3 |
