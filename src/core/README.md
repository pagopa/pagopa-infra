...
| <a name="input_apicfg_core_cache_path_value"></a> [apicfg\_core\_cache\_path\_value](#input\_apicfg\_core\_cache\_path\_value) | apicfg core cache path | `string` | `"pagopa-api-config-core-service/o"` | no |
