...
resource "azurerm_private_dns_a_record" "platform_dns_a_private_apim" {
  ...
  records             = var.enabled_features.apim_v2 ? concat(module.apim.private_ip_addresses, data.azurerm_api_management.apim_v2[0].private_ip_addresses) : module.apim.private_ip_addresses
  tags                = var.tags
}
