...
module "api_config_app_service" {
  ...
  app_settings = {
    ...
    AFM_UTILS_HOST             = var.env_short == "p" ? "https://api.platform.pagopa.it/afm/utils-service/v1" : format("https://api.%s.platform.pagopa.it/afm/utils-service/v1", lower(var.tags["Environment"]))
