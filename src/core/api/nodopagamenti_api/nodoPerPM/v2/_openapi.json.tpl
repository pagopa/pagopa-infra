{
    ...
    "components": {
        "schemas": {
            ...
            "GooglePayAdditionalPaymentInformations": {
                "type": "object",
                "description": "Additional payment data pertaining to GooglePay payments",
                "properties": {
                    "rrn": {
                        "type": "string",
                        "description": "Transaction identifier on the google pay circuit"
                    },
                    "totalAmount": {
                        "type": "string",
                        "description": "sum of payment advices amount and fee, converted in string",
            ...
            "GooglePayClosePaymentRequestV2": {
                "required": [
                    "fee",
                    "idBrokerPSP",
                    "idChannel",
                ...
                "properties": {
                    ...
                    "additionalPaymentInformations": {
                        "$ref": "#/components/schemas/GooglePayAdditionalPaymentInformations"
                    }
                }
            },
            "ClosePaymentRequestV2": {
                "oneOf": [
                    ...
                    {
                        "$ref": "#/components/schemas/GooglePayClosePaymentRequestV2"
                    }
                ],
                "discriminator": {
                    ...
                    "mapping": {
                        ...
                        "GOOG": "#/components/schemas/GooglePayClosePaymentRequestV2"
                    }
                }
            },
            "TransactionDetails": {
