...
locals {
  apim_pdf_engine_service_api = { # java
    ...
    subscription_required = true
#    service_url           = var.pdf_engine_app_ha_enabled ? module.shared_pdf_engine_app_service_java_ha[0].default_site_hostname : module.shared_pdf_engine_app_service_java.default_site_hostname
  ...
  apim_pdf_engine_node_service_api = { # node
    ...
    subscription_required = true
#    service_url           = var.pdf_engine_app_ha_enabled ? module.shared_pdf_engine_app_service_ha[0].default_site_hostname : module.shared_pdf_engine_app_service.default_site_hostname
