...
| <a name="input_pagopa_shared_toolbox_auth_client_id"></a> [pagopa\_shared\_toolbox\_auth\_client\_id](#input\_pagopa\_shared\_toolbox\_auth\_client\_id) | n/a | `string` | n/a | yes |
