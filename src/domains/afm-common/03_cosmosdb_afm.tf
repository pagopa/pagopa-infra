...
module "afm_marketplace_cosmosdb_database" {
  source              = "git::https://github.com/pagopa/terraform-azurerm-v3.git//cosmosdb_sql_database?ref=v6.2.1"
  name                = "db"
  resource_group_name = azurerm_resource_group.afm_rg.name
...
module "afm_marketplace_cosmosdb_containers" {
  source   = "git::https://github.com/pagopa/terraform-azurerm-v3.git//cosmosdb_sql_container?ref=v6.2.1"
