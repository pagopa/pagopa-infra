...
derivedTransferListRemittanceInformation derive({_viewSubject} = iif(contains(["pagamento multibeneficiario"], #item==paymentRemittanceInformation),transferListRemittanceInformation,paymentRemittanceInformation)) ~> derivedCartViewSubject
...
derivedCartViewSubject sink(allowSchemaDrift: true,
    validateSchema: false,
    deletable:false,
    insertable:true,
    updateable:false,
