<policies>
  ...
  <inbound>
    ...
    <!-- Session eCommerce START-->
        <choose>
          <when condition="@("NPG".Equals("{{ecommerce-for-io-pm-npg-ff}}") || (("FF".Equals("{{ecommerce-for-io-pm-npg-ff}}") && "{{pay-wallet-family-friends-user-ids}}".Contains(((string)context.Variables["sessionTokenUserId"]))) )">
            <!-- Check JWT START-->
