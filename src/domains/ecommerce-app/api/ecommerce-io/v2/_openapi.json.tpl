  ...
  "components": {
      ...
      "NewTransactionResponse": {
        ...
        "properties": {
          ...
          "authToken": {
            ...
            "example": "eyJhbGciOiJIUzI1NiJ9.eyJleHAiOiIyMDI0LTA3LTA5VDA3OjU0OjMwLjM1NVoiLCJpYXQiOiIyMDI0LTA3LTA5VDA3OjU0OjMwLjM1NVoifQ.bg-pgWgaKJJrBgnEUnrzShP7-8r9G7awutMieDf8Hfo"
          }
        },
        "required": [
          "transactionId",
    ...
    "securitySchemes": {
      ...
      "eCommerceSessionToken": {
        "type": "http",
        "scheme": "bearer",
        "description": "JWT session token generated by eCommerce when creating a new transaction with `POST /transactions`"
      }
    }
  }
}
