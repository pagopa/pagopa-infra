  ...
  "paths": {
    "/pay": {
      "get": {
        ...
        "description": "Payment page for Payment Manager",
        "operationId": "getWebView",
        "parameters": [
          {
            "in": "query",
            "name": "idWallet",
            "description": "Unique identifier for user wallet.",
            "schema": {
              "type": "string"
            },
            "required": true
          },
          {
            "in": "query",
            "name": "idPayment",
            "description": "Unique identifier for activated payment.",
            "schema": {
              "type": "string"
            },
            "required": true
          },
          {
            "in": "query",
            "name": "sessionToken",
            "description": "Authorization token for the payment session.",
            "schema": {
              "type": "string"
            },
            "required": true
          },
          {
            "in": "query",
            "name": "language",
            "description": "Language code for the language the page will be rendered in.",
            "schema": {
              "type": "string"
            },
            "required": false
