<policies>
  ...
  <inbound>
      ...
      <set-variable name="transactionsOperationId" value="newTransaction,getTransactionInfo,transactionOutcomes,requestTransactionUserCancellation,requestTransactionAuthorization" />
