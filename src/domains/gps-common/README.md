...
| Name | Type |
| ---- | ---- |
| [azapi_resource.gpd_postgres_archive_lifecycle_linked_service](https://registry.terraform.io/providers/azure/azapi/latest/docs/resources/resource) | resource |
| [azapi_resource.gpd_postgres_lifecycle_linked_service](https://registry.terraform.io/providers/azure/azapi/latest/docs/resources/resource) | resource |
...
| [azapi_resource.pipeline_lifecycle_management](https://registry.terraform.io/providers/azure/azapi/latest/docs/resources/resource) | resource |
| [azapi_resource.pipeline_lifecycle_script_execution](https://registry.terraform.io/providers/azure/azapi/latest/docs/resources/resource) | resource |
...
| [azurerm_data_factory_trigger_schedule.pipeline_lifecycle_management_schedule](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/data_factory_trigger_schedule) | resource |
...
| [azurerm_key_vault_secret.ehub_rtp_cdc_rx_connection_string](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.ehub_rtp_cdc_tx_connection_string](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| [azurerm_key_vault_secret.flyway_db_storico_url](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| [azurerm_key_vault_secret.gpd_technical_support_apd_jdbc_url](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.gpd_technical_support_biz_cosmos_key](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.gpd_technical_support_reconciliation_cosmos_key](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| [azurerm_key_vault_secret.pgres_adf_pipeline_pwd_secret](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| [azurerm_key_vault_secret.pgres_apd_storico_pwd_secret](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.pgres_gpd_technical_support_login_secret](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.pgres_gpd_technical_support_password_secret](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| [azurerm_monitor_metric_alert.pipeline_lifecycle_management_multiple_failures](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.pipeline_lifecycle_management_single_failure](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.pipeline_lifecycle_script_execution_delete_multiple_failures](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.pipeline_lifecycle_script_execution_delete_single_failure](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.pipeline_lifecycle_script_execution_mark_archived_multiple_failures](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
| [azurerm_monitor_metric_alert.pipeline_lifecycle_script_execution_mark_archived_single_failure](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_metric_alert) | resource |
...
| [azurerm_postgresql_flexible_server_configuration.pg_log_min_duration_statement](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/postgresql_flexible_server_configuration) | resource |
...
| [azurerm_private_dns_cname_record.gpd_db_readonly_cname_record](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/private_dns_cname_record) | resource |
...
| [azurerm_storage_container.gpd_receipt_dead_letter](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_container) | resource |
...
| [azurerm_eventhub_authorization_rule.pagopa-evh-rtp-integration-cdc-rx](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/eventhub_authorization_rule) | data source |
| [azurerm_eventhub_authorization_rule.pagopa-evh-rtp-integration-cdc-tx](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/eventhub_authorization_rule) | data source |
...
| [azurerm_key_vault_secret.pgres_adf_login](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
...
| [azurerm_key_vault_secret.pgres_apd_storico_user_login](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
| [azurerm_key_vault_secret.pgres_storico_admin_login](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
| [azurerm_key_vault_secret.pgres_storico_admin_pwd](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
...
| [azurerm_resource_group.bizevents_rg](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/resource_group) | data source |
...
| [azurerm_resource_group.nodo_sec_rg](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/resource_group) | data source |
...
| [azurerm_subnet.vpn_snet](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/subnet) | data source |
...
| <a name="input_gpd_db_storico_name"></a> [gpd\_db\_storico\_name](#input\_gpd\_db\_storico\_name) | GPD Storico DB name | `string` | `"apd"` | no |
| <a name="input_gpd_reconciliation_reports_throughput"></a> [gpd\_reconciliation\_reports\_throughput](#input\_gpd\_reconciliation\_reports\_throughput) | Max throughput for GPD reconciliation reports Cosmos container | `number` | `1000` | no |
| <a name="input_gpd_reconciliation_runs_throughput"></a> [gpd\_reconciliation\_runs\_throughput](#input\_gpd\_reconciliation\_runs\_throughput) | Max throughput for GPD reconciliation runs Cosmos container | `number` | `1000` | no |
...
| <a name="input_pgflex_storico_params"></a> [pgflex\_storico\_params](#input\_pgflex\_storico\_params) | ##################### GPD-PG-STORICO-START# ##################### | <pre>object({<br/>    pgres_flex_pgbouncer_enabled           = bool<br/>    alerts_enabled                         = bool<br/>    pgres_flex_diagnostic_settings_enabled = bool<br/>    max_connections                        = number<br/>    enable_private_dns_registration        = optional(bool, false)<br/>    max_worker_processes                   = number<br/>    storage_mb                             = number<br/>  })</pre> | n/a | yes |
| <a name="input_pgres_flex_params"></a> [pgres\_flex\_params](#input\_pgres\_flex\_params) | Postgres Flexible | <pre>object({<br/>    private_endpoint_enabled                         = bool<br/>    sku_name                                         = string<br/>    db_version                                       = string<br/>    storage_mb                                       = string<br/>    zone                                             = number<br/>    backup_retention_days                            = number<br/>    geo_redundant_backup_enabled                     = bool<br/>    high_availability_enabled                        = bool<br/>    standby_availability_zone                        = number<br/>    pgbouncer_enabled                                = bool<br/>    alerts_enabled                                   = bool<br/>    max_connections                                  = number<br/>    enable_private_dns_registration                  = optional(bool, false)<br/>    enable_private_dns_registration_virtual_endpoint = optional(bool, false)<br/>    max_worker_process                               = number<br/>    wal_level                                        = string<br/>    shared_preoload_libraries                        = string<br/>    public_network_access_enabled                    = bool<br/>    log_min_duration_statement                       = optional(number)<br/>    log_lock_waits                                   = optional(string)<br/>  })</pre> | `null` | no |
