...
| <a name="input_gpd_enable_private_endpoint"></a> [gpd\_enable\_private\_endpoint](#input\_gpd\_enable\_private\_endpoint) | If true, create a private endpoint for the SFTP storage account | `bool` | n/a | yes |
