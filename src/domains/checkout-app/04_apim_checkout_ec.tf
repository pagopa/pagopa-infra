...
data "azurerm_key_vault_secret" "ecommerce_payment_requests_primary_api_for_checkout_ec_key" {
...
resource "azurerm_api_management_named_value" "ecommerce_payment_requests_api_key_value_for_checkout_ec" {
  ...
  value               = data.azurerm_key_vault_secret.ecommerce_payment_requests_primary_api_for_checkout_ec_key.value
  secret              = true
}
