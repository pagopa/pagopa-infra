...
module "reporting_fdr_function" {
  ...
  app_settings = {
    ...
    EHUB_FDR_CONNECTION_STRING = var.enabled_features.eventhub_ha ? data.azurerm_eventhub_authorization_rule.events_03.primary_connection_string : data.azurerm_eventhub_authorization_rule.events.primary_connection_string
