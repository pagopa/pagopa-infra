...
locals {
  function_re_to_datastore_app_settings = {
    ...
    EVENTHUB_CONN_STRING = var.enabled_features.eventhub_ha ? data.azurerm_eventhub_authorization_rule.pagopa-evh-ns03_fdr-re_fdr-re-rx.primary_connection_string : data.azurerm_eventhub_authorization_rule.pagopa-evh-ns01_fdr-re_fdr-re-rx.primary_connection_string
