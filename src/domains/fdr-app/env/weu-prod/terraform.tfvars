...
fdr_soap_request_psp_whitelist    = "ABI03589" # after monitor with nexi we decide to change config to https://config.platform.pagopa.it/payment-service-providers/ABI03589
