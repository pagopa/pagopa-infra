...
resource "azurerm_monitor_scheduled_query_rules_alert" "alert_fdr_internal_availability-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "fdr-internal-app-exception-v2"
...
resource "azurerm_monitor_scheduled_query_rules_alert" "alert_fdr_psp_availability-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "fdr-psp-app-exception-v2"
  location            = var.location
...
resource "azurerm_monitor_scheduled_query_rules_alert" "alert_fdr_org_availability-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "fdr-org-app-exception-v2"
  location            = var.location
