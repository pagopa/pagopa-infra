...
resource "azurerm_api_management_api_version_set" "api_fdr_technical_support_api" {
...
module "api_fdr_technical_support_api_v1" {
  ...
  subscription_required = true
  version_set_id        = azurerm_api_management_api_version_set.api_fdr_technical_support_api.id
  api_version           = "v1"
