{
  ...
  "components" : {
    "schemas" : {
      "BundleRequest" : {
        "required" : [ "abi", "idBrokerPsp", "idChannel", "onUs", "pspBusinessName" ],
        "type" : "object",
        "properties" : {
          "idChannel" : {
            "type" : "string"
      ...
      "PaymentMethod" : {
        "required" : [ "description", "group", "method_management", "name", "payment_method_asset", "payment_method_id", "range_amount", "status", "user_device", "user_touchpoint", "validity_date_from" ],
        "type" : "object",
        "properties" : {
          "id" : {
            "type" : "string"
      ...
      "PageInfo" : {
        "required" : [ "itemsFound", "limit", "page", "totalPages" ],
        "type" : "object",
        "properties" : {
          "page" : {
            "type" : "integer",
      ...
      "PublicBundleRequest" : {
        "required" : [ "ciFiscalCode", "idBundle", "idBundleRequest" ],
        "type" : "object",
        "properties" : {
          "idBundle" : {
            "type" : "string"
      ...
      "BundleCreditorInstitutionResource" : {
        "required" : [ "ciBundleDetails", "pageInfo" ],
        "type" : "object",
        "properties" : {
          "ciBundleDetails" : {
            "type" : "array",
      ...
      "PaymentTypes" : {
        "required" : [ "pageInfo", "paymentTypes" ],
        "type" : "object",
        "properties" : {
          "pageInfo" : {
            "$ref" : "#/components/schemas/PageInfo"
      ...
      "BundleAttribute" : {
        "required" : [ "idBundleAttribute", "insertedDate" ],
        "type" : "object",
        "properties" : {
          "maxPaymentAmount" : {
            "type" : "integer",
      ...
      "BundleDetailsAttributes" : {
        "required" : [ "attributes", "insertedDate" ],
        "type" : "object",
        "properties" : {
          "validityDateFrom" : {
            "type" : "string",
