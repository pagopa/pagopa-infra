...
data "azurerm_api_management_api" "apim_backoffice-helpdesk_v1" { # p-backoffice-helpdesk-api-v1
...
resource "azurerm_api_management_subscription" "status_page_improvement_api_key_subkey" {
  ...
  api_id        = data.azurerm_api_management_api.apim_backoffice-helpdesk_v1.id
