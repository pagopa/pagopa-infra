...
#   app_service_id   = module.printit_pdf_engine_app_service.id
#   app_service_name = module.printit_pdf_engine_app_service.name
#
#   # App service
#   name                = "staging"
#   resource_group_name = azurerm_resource_group.printit_pdf_engine_app_service_rg.name
...
#   target_resource_id  = module.printit_pdf_engine_app_service.plan_id
...
#         metric_resource_id       = module.printit_pdf_engine_app_service.id
...
#         metric_resource_id       = module.printit_pdf_engine_app_service.plan_id
...
#   # App service plan
#   # app_service_plan_id = module.printit_pdf_engine_app_service.plan_id
#   app_service_id   = module.printit_pdf_engine_app_service_java.id
#   app_service_name = module.printit_pdf_engine_app_service_java.name
#
#   # App service
#   name                = "staging"
#   resource_group_name = azurerm_resource_group.printit_pdf_engine_app_service_rg.name
...
#   resource_group_name = azurerm_resource_group.printit_pdf_engine_app_service_rg.name
#   location            = azurerm_resource_group.printit_pdf_engine_app_service_rg.location
#   target_resource_id  = module.printit_pdf_engine_app_service_java.plan_id
#   enabled             = var.app_service_pdf_engine_autoscale_enabled
#
#   profile {
#     name = "default"
...
#       metric_trigger {
#         metric_name              = "Requests"
#         metric_resource_id       = module.printit_pdf_engine_app_service_java.id
#         metric_namespace         = "microsoft.web/sites"
#         time_grain               = "PT1M"
#         statistic                = "Average"
#         time_window              = "PT5M"
...
#       metric_trigger {
#         metric_name              = "CpuPercentage"
#         metric_resource_id       = module.printit_pdf_engine_app_service_java.plan_id
#         metric_namespace         = "microsoft.web/serverfarms"
#         time_grain               = "PT1M"
#         statistic                = "Average"
#         time_window              = "PT5M"
