...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_key_vault"></a> [key\_vault](#module\_key\_vault) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault | v8.11.0 |
| <a name="module_letsencrypt_receipt"></a> [letsencrypt\_receipt](#module\_letsencrypt\_receipt) | git::https://github.com/pagopa/terraform-azurerm-v3.git//letsencrypt_credential | v8.11.0 |
