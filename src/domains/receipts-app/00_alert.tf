#resource "azurerm_monitor_scheduled_query_rules_alert" "receiptsdatastore-availability" {
#  count               = var.env_short != "d" ? 1 : 0
#  resource_group_name = "dashboards"
#  name                = "pagopa-${var.env_short}-receiptsdatastore-availability"
...
#  description    = "Availability receiptsdatastore "
#  enabled        = true
#  query = (<<-QUERY
#let threshold = 0.95;
#union traces,exceptions
#| where cloud_RoleName == "pagopareceiptsdatastore"
