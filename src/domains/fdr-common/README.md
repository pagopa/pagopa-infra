...
| <a name="input_pgres_flex_archive_params"></a> [pgres\_flex\_archive\_params](#input\_pgres\_flex\_archive\_params) | Postgres Flexible | <pre>object({<br/>    alerts_enabled                         = bool<br/>    pgres_flex_diagnostic_settings_enabled = bool<br/>    enable_private_dns_registration        = optional(bool, false)<br/>    storage_mb                             = number<br/>    db_version                             = number<br/>  })</pre> | n/a | yes |
