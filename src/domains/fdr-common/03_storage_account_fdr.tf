...
module "fdr_conversion_sa" {
  ...
  blob_change_feed_retention_in_days = var.fdr_storage_account.backup_enabled ? var.fdr_storage_account.blob_delete_retention_days : null
  blob_container_delete_retention_days = var.fdr_storage_account.backup_enabled ? var.fdr_storage_account.blob_delete_retention_days : null
  blob_storage_policy = var.fdr_storage_account.backup_enabled ? {
    enable_immutability_policy = false
    blob_restore_policy_days = var.fdr_storage_account.blob_delete_retention_days
  } : null
