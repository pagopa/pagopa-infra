...
variable "helpdesk_service_requests_api_key_use_primary" {
  type        = bool
  description = "If true the current active API key used for helpdesk requests will be the primary one."
  default     = true
}
