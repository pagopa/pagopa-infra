...
| <a name="module_letsencrypt_fdr"></a> [letsencrypt\_fdr](#module\_letsencrypt\_fdr) | git::https://github.com/pagopa/terraform-azurerm-v3.git//letsencrypt_credential | v8.11.0 |
