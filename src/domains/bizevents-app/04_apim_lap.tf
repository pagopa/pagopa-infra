...
module "apim_api_bizevents_lap_api_v1" {
  ...
  api_management_name   = local.pagopa_apim_name
  resource_group_name   = local.pagopa_apim_rg
  product_ids           = var.env_short == "p" ? [module.apim_lap_product.product_id, azurerm_api_management_product.technical_support_api_product.product_id] : [module.apim_lap_product.product_id, module.apim_bizevents_product.product_id, module.apim_bizevents_product_all_in_one[0].product_id, azurerm_api_management_product.technical_support_api_product.product_id]
  subscription_required = local.apim_lap_service_api.subscription_required
