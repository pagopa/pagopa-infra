...
variable "_plan_idh_tier" {
  type        = string
  description = "The IDH resource tier for "
}

variable "_autoscale_settings" {
  type = object({
  ...
  description = "Autoscale settings for "
}
...
variable "_image" {
   ...
   description = "Docker image settings for "
}
