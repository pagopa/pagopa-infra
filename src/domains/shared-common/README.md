...
| <a name="input_cidr_subnet_test_data_storage_account"></a> [cidr\_subnet\_test\_data\_storage\_account](#input\_cidr\_subnet\_test\_data\_storage\_account) | Storage account network address space. | `list(string)` | n/a | yes |
