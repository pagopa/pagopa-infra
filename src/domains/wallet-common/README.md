...
| [azurerm_key_vault_secret.user-wallet-token-for-tests](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
