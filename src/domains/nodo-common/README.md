...
| <a name="input_cosmos_mongo_db_nodo_re_params"></a> [cosmos\_mongo\_db\_nodo\_re\_params](#input\_cosmos\_mongo\_db\_nodo\_re\_params) | n/a | <pre>object({<br>    enable_serverless  = bool<br>    enable_autoscaling = bool<br>    throughput         = number<br>    max_throughput     = number<br>  })</pre> | n/a | yes |
