module "cosmosdb_account_nodo_re" {
  ...
  allowed_virtual_network_subnet_ids  = var.env_short == "p" ? [data.azurerm_subnet.aks_subnet.id, data.azurerm_subnet.nodo_re_to_datastore_function_snet[0].id] : [data.azurerm_subnet.aks_subnet.id, data.azurerm_subnet.nodo_re_to_datastore_function_snet[0].id, data.azurerm_subnet.vpn_subnet.id]
