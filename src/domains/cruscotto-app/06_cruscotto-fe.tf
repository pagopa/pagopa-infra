...
# resource "azurerm_static_web_app" "crusc8_backoffice_static_web_app" {
...
# resource "azurerm_key_vault_secret" "crusc8_backoffice_static_app_key" {
#   count = var.env_short == "d" ? 1 : 0

#   name         = "backoffice-static-app-key"
#   value        = azurerm_static_web_app.crusc8_backoffice_static_web_app[0].api_key
#   content_type = "text/plain"
