...
# crus8 database
resource "azurerm_postgresql_flexible_server_database" "crus8_db" {
  name      = var.pgres_flex_crus8_db_name
  server_id = module.postgres_flexible_server_crus8.id
...
# crus8 database
resource "azurerm_postgresql_flexible_server_database" "crus83_db" {
  name      = "cruscotto"
  server_id = module.postgres_flexible_server_crus8.id
  collation = "en_US.utf8"
  charset   = "utf8"
...
resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_max_connection" {
...
resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_ignore_startup_parameters" {
...
resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_min_pool_size" {
  count     = var.pgres_flex_params.pgres_flex_pgbouncer_enabled ? 1 : 0
...
resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_max_worker_process" {
  name      = "max_worker_processes"
  server_id = module.postgres_flexible_server_crus8.id
  value     = var.pgres_flex_params.max_worker_process # var.env_short == "d" ? 16 : 32
}

resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_wal_level" {
...
resource "azurerm_postgresql_flexible_server_configuration" "crus8_db_flex_shared_preoload_libraries" {
  count = var.pgres_flex_params.wal_level != null ? 1 : 0
...
resource "azurerm_postgresql_flexible_server_database" "crus8_replica_db" {
  count     = var.env_short == "p" ? 0 : 1
  name      = "${var.pgres_flex_crus8_db_name}-replica"
  server_id = module.postgres_flexible_server_crus8.id
  collation = "en_US.utf8"
  charset   = "utf8"
}
