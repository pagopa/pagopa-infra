...
data "azurerm_key_vault_secret" "pgres_flex_admin_login" {
  ...
  key_vault_id = data.azurerm_key_vault.postgres_key_vault.id
}
...
module "postgres_flexible_snet" {
  source               = "git::https://github.com/pagopa/terraform-azurerm-v3.git//subnet?ref=v4.1.17"
...
module "postgres_flexible_server" {
  source              = "git::https://github.com/pagopa/terraform-azurerm-v3.git//postgres_flexible_server?ref=v4.1.17"
