{
  ...
  "info" : {
    ...
    "version" : "0.57.0-4-PAGOPA-1378-sviluppo-caricamento-massivo-iban-da-csv"
  },
  "servers" : [ {
    ...
    "/refresh/config/{configtype}" : {
      "get" : {
        ...
        "parameters" : [ {
          ...
          "schema" : {
            "type" : "string",
            "enum" : [ "FTP_SERVER", "INFORMATIVA_CDI", "INFORMATIVA_PA", "PA", "PDD", "PSP", "GLOBAL" ]
          }
        } ],
        "responses" : {
          "200" : {
  ...
  "components" : {
    "schemas" : {
      ...
      "ChannelPsp" : {
        "required" : [ "business_name", "enabled", "payment_types", "psp_code" ],
        "type" : "object",
        "properties" : {
          "psp_code" : {
            "type" : "string"
