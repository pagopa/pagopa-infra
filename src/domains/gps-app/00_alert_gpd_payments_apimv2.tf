...
resource "azurerm_monitor_scheduled_query_rules_alert" "opex_pagopa-gpd-payments-soap-responsetime-upd-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "pagopa-${var.env_short}-opex_pagopa-gpd-payments-soap-responsetime @ _gpd-payments-v2"
...
resource "azurerm_monitor_scheduled_query_rules_alert" "opex_pagopa-gpd-payments-soap-availability-upd-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "pagopa-${var.env_short}-opex_pagopa-gpd-payments-soap-availability @ _gpd-payments-v2"
  location            = var.location
...
resource "azurerm_monitor_scheduled_query_rules_alert" "opex_pagopa-gpd-payments-rest-responsetime-upd-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "pagopa-${var.env_short}-opex_pagopa-gpd-payments-rest-responsetime @ _gpd-payments-v2"
  location            = var.location
...
resource "azurerm_monitor_scheduled_query_rules_alert" "opex_pagopa-gpd-payments-rest-availability-upd-v2" {
  count               = var.env_short == "p" ? 1 : 0
  resource_group_name = "dashboards"
  name                = "pagopa-${var.env_short}-opex_pagopa-gpd-payments-rest-availability @ _gpd-payments-v2"
  location            = var.location
