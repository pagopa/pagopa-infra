...
resource "azurerm_api_management_api" "apim_nodo_per_psp_api_v1_auth" {
  ...
  import {
    content_format = "wsdl"
    content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPsp/v1/auth/nodoPerPsp.wsdl")
    wsdl_selector {
...
resource "azurerm_api_management_api_policy" "apim_nodo_per_psp_policy_auth" {
  ...
  xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPsp/v1/_base_policy.xml.tpl", {
...
resource "azurerm_api_management_api" "apim_nodo_per_psp_richiesta_avvisi_api_v1_auth" {
  ...
  import {
    content_format = "wsdl"
    content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPspRichiestaAvvisi/v1/auth/nodoPerPspRichiestaAvvisi.wsdl")
    wsdl_selector {
...
resource "azurerm_api_management_api_policy" "apim_nodo_per_psp_richiesta_avvisi_policy_auth" {
  ...
  xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPspRichiestaAvvisi/v1/_base_policy.xml.tpl", {
    is-nodo-decoupler-enabled = var.apim_nodo_auth_decoupler_enable
  })
