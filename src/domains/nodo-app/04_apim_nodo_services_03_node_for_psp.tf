...
resource "azurerm_api_management_api_policy" "apim_node_for_psp_policy" {
  ...
  xml_content = templatefile("./api/legacy/nodopagamenti_api/nodeForPsp/v1/_base_policy.xml.tpl", {
...
resource "azurerm_api_management_api_operation_policy" "nm3_activate_verify_policy" { # activatePaymentNoticeV1 verificatore
  ...
  api_management_name = local.pagopa_apim_name
  resource_group_name = local.pagopa_apim_rg
  operation_id        = var.env_short == "d" ? "637601f8c257810fc0ecfe01" : var.env_short == "u" ? "6a5f489e75a838165ccb1c51" : "61dedafc2a92e81a0c7a58fc"
...
resource "azurerm_api_management_api_operation_policy" "nm3_activate_v2_verify_policy" { # activatePaymentNoticeV2 verificatore
  ...
  api_management_name = local.pagopa_apim_name
  resource_group_name = local.pagopa_apim_rg
  operation_id        = var.env_short == "d" ? "637601f8c257810fc0ecfe06" : var.env_short == "u" ? "6a5f489e75a838165ccb1c56" : "63c559672a92e811a8f33a00"
