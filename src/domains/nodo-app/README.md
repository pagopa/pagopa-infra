...
| [azurerm_eventhub.pagopa-evh-ns02_nodo-dei-pagamenti-re_nodo-dei-pagamenti-verifyko](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/eventhub) | data source |
...
| <a name="input_nodo_verifyko_to_datastore_function_app_image_tag"></a> [nodo\_verifyko\_to\_datastore\_function\_app\_image\_tag](#input\_nodo\_verifyko\_to\_datastore\_function\_app\_image\_tag) | Nodo RE to Datastore function app docker image tag. Defaults to 'latest' | `string` | `"latest"` | no |
