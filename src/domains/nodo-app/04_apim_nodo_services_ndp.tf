...
module "apim_nodo_dei_pagamenti_product_ndp" {
  ...
  product_id   = "nodo-ndp"
  display_name = "Nodo dei Pagamenti NDP PagoPA"
  description  = "Product for Nodo dei Pagamenti NDP PagoPA"
...
locals {
  apim_node_for_psp_api_ndp = {
    display_name          = "Node for PSP NDP PagoPA"
...
locals {
  apim_nodo_per_psp_api_ndp = {
    display_name          = "Nodo per PSP NDP PagoPA"
...
locals {
  apim_nodo_per_psp_richiesta_avvisi_api_ndp = {
    display_name          = "Nodo per PSP Richiesta Avvisi NDP PagoPA"
...
#     display_name          = "Node for IO WS NDP PagoPA"
...
locals {
  apim_psp_for_node_api_ndp = {
    display_name          = "PSP for Node NDP PagoPA"
...
locals {
  apim_nodo_per_pa_api_ndp = {
    display_name          = "Nodo per PA NDP PagoPA"
...
locals {
  apim_nodo_monitoring_api_ndp = {
    display_name          = "Nodo monitoring NDP PagoPA"
    description           = "Nodo monitoring NDP PagoPA"
