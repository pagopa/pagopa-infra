...
resource "azurerm_kubernetes_cluster_node_pool" "nodo_pool" {
  ...
  ### autoscaling
  enable_auto_scaling = true # PSFC-TODO da ripristinare prima del merge a true
  node_count          = var.nodo_user_node_pool.node_count_min     # PSFC-TODO da ripristinare prima del merge a var.nodo_user_node_pool.node_count_min
