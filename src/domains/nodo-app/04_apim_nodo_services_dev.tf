...
module "apim_nodo_dei_pagamenti_product_dev" {
  ...
  policy_xml = templatefile("./api_product/legacy/nodo_pagamenti_api/_base_policy.xml", {
...
locals {
  ...
  api_nodo_product_dev = var.env_short == "d" ? [
    format("%s-node-for-psp-api-dev", var.env_short),
    format("%s-nodo-per-psp-api-dev", var.env_short),
    format("%s-node-for-io-api-dev", var.env_short),
    format("%s-nodo-per-pa-api-dev", var.env_short)
  ] : []
...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodeForPsp/v1/nodeForPsp.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodeForPsp/v1/_base_policy_dev.xml.tpl", {
...
#
# #   #tfsec:ignore:GEN005
# #   xml_content = file("./api/legacy/nodopagamenti_api/nodeForPsp/v1/activate_nm3.xml")
# # }
#
...
#
# #   #tfsec:ignore:GEN005
# #   xml_content = file("./api/legacy/nodopagamenti_api/nodeForPsp/v2/activate_nm3.xml")
# # }
#
# ######################
# ## WS nodo per psp ##
...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPsp/v1/nodoPerPsp.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPsp/v1/_base_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
# }
#
...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPspRichiestaAvvisi/v1/nodoPerPspRichiestaAvvisi.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPspRichiestaAvvisi/v1/_base_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
#
# }
...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodeForIO/v1/nodeForIO.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodeForIO/v1/_base_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
#
# }
...
# #  import {
# #    content_format = "wsdl"
# #    content_value  = file("./api/legacy/nodopagamenti_api/pspForNode/v1/pspForNode.wsdl")
# #    wsdl_selector {
...
# #  resource_group_name = local.pagopa_apim_rg
# #
# #  xml_content = file("./api/legacy/nodopagamenti_api/pspForNode/v1/_base_policy.xml")
# #}
#
#
# ######################
...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPa/v1/NodoPerPa.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPa/v1/_base_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
# }
#
...
#   count = var.env_short == "d" ? 1 : 0
#
#   api_name            = format("%s-nodo-per-pm-api-dev-v1", local.product)
#   api_management_name = local.pagopa_apim_name
#   resource_group_name = local.pagopa_apim_rg
#   operation_id        = "closePayment"
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPM/v1/_add_v1_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
# }
#
...
#   source = "git::https://github.com/pagopa/azurerm.git//api_management_api?ref=v2.1.13"
#
#   name                  = format("%s-nodo-per-pm-api-dev", local.product)
#   api_management_name   = local.pagopa_apim_name
#   resource_group_name   = local.pagopa_apim_rg
#   subscription_required = local.apim_nodo_per_pm_api_dev.subscription_required
#   version_set_id        = azurerm_api_management_api_version_set.nodo_per_pm_api_dev[0].id
...
#   })
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPM/v2/_base_policy_dev.xml.tpl", {
#     is-nodo-decoupler-enabled = false
#   })
# }
#
...
#   content_value = templatefile("./api/legacy/nodopagamenti_api/monitoring/v1/_NodoDeiPagamenti.openapi.json.tpl", {
#     host    = local.apim_hostname
#     service = module.apim_nodo_dei_pagamenti_product_dev[0].product_id
#   })
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/monitoring/v1/_base_policy.xml.tpl", {
