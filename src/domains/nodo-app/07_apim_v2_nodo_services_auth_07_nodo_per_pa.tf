...
#  version_set_id        = azurerm_api_management_api_version_set.nodo_per_pa_api_auth[0].id
#  version               = "v1"
...
#  import {
#    content_format = "wsdl"
#    content_value  = file("./apim_v2/api/nodopagamenti_api/nodoPerPa/v1/auth/NodoPerPa.wsdl")
#    wsdl_selector {
...
#  count = var.enabled_features.apim_v2 ? 1 : 0
#
#  api_name            = azurerm_api_management_api.apim_nodo_per_pa_api_v1_auth[0].name
#  api_management_name = local.pagopa_apim_v2_name
#  resource_group_name = local.pagopa_apim_v2_rg
#
