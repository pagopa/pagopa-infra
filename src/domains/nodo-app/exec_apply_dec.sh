...
-target="azurerm_api_management_api_operation_policy.nodoInviaCarrelloRPT_v1_policy" \
-target="terraform_data.sha256_nodoChiediCopiaRT_v1_policy" \
...
-target="module.apim_node_for_ecommerce_product" \
...
-target=azurerm_api_management_policy_fragment.ndphost_header \
...
-target="terraform_data.sha256_apim_node_for_pa_api_v1_auth" \
-target="module.apim_node_for_pa_api_v1_auth"
