...
module "apim_nodo_dei_pagamenti_product_auth" {
  ...
  display_name = "Nodo dei Pagamenti (Nuova Connettività) 2.0"
  description  = "Product for Nodo dei Pagamenti (Nuova Connettività) 2.0"

  api_management_name = data.azurerm_api_management.apim_migrated[0].name
  resource_group_name = data.azurerm_resource_group.api_rg_api.name
