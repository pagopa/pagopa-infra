...
resource "azurerm_api_management_api" "apim_nodo_per_pa_api_v1_auth" {
  ...
  import {
    content_format = "wsdl"
    content_value  = file("./api/legacy/nodopagamenti_api/nodoPerPa/v1/auth/NodoPerPa.wsdl")
    wsdl_selector {
...
resource "azurerm_api_management_api_policy" "apim_nodo_per_pa_policy_auth" {
  ...
  xml_content = templatefile("./api/legacy/nodopagamenti_api/nodoPerPa/v1/_base_policy.xml.tpl", {
...
resource "azurerm_api_management_api_operation_policy" "nodoInviaRPT_api_auth_v1_policy" {
  ...
  resource_group_name = local.pagopa_apim_rg
  api_management_name = local.pagopa_apim_name
  operation_id        = var.env_short == "d" ? "6352c3bcc257810f183b3984" : var.env_short == "u" ? "6a5f489d75a838165ccb1c37" : "63e5d8212a92e80448d38dff"
...
resource "terraform_data" "sha256_nodoInviaRPT_api_auth_v1_policy" {
  input = sha256(file("./api/legacy/nodopagamenti_api/nodoPerPa/v1/nodoInviaRPT_policy.xml"))
}
...
resource "azurerm_api_management_api_operation_policy" "nodoInviaCarrelloRPT_api_auth_v1_policy" {
  ...
  resource_group_name = local.pagopa_apim_rg
  api_management_name = local.pagopa_apim_name
  operation_id        = var.env_short == "d" ? "6352c3bcc257810f183b3985" : var.env_short == "u" ? "6a5f489d75a838165ccb1c38" : "63e5d8212a92e80448d38e00"
...
resource "terraform_data" "sha256_nodoInviaCarrelloRPT_api_auth_v1_policy" {
  input = sha256(file("./api/legacy/nodopagamenti_api/nodoPerPa/v1/nodoInviaCarrelloRPT_policy.xml"))
}
