...
#   import {
#     content_format = "wsdl"
#     content_value  = file("./api/legacy/nodopagamenti_api/nodeForPa/v1/auth/NodeForPa.wsdl")
#     wsdl_selector {
...
#   resource_group_name = local.pagopa_apim_rg
#
#   xml_content = templatefile("./api/legacy/nodopagamenti_api/nodeForPa/v1/_base_policy.xml.tpl", {
