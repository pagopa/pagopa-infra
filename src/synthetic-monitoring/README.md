...
| Name | Source | Version |
|------|--------|---------|
| <a name="module___v4__"></a> [\_\_v4\_\_](#module\_\_\_v4\_\_) | git::https://github.com/pagopa/terraform-azurerm-v4 | 316b4ea15abec7b5f7fc88d010eb9186cebc6298 |
...
| [azurerm_cdn_frontdoor_endpoint.checkout_cdn_endpoint](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/cdn_frontdoor_endpoint) | data source |
...
| <a name="input_enabled_resource"></a> [enabled\_resource](#input\_enabled\_resource) | Feature flags | <pre>object({<br/>    test_nexi_postgres         = optional(bool, false),<br/>    synthetic_on_demand        = optional(bool, false),<br/>    cloudo_ndp_switch          = optional(bool, false),<br/>    cloudo_checkout_cdn_switch = optional(bool, false)<br/>  })</pre> | n/a | yes |
